...
OS.prototype.configure = function(options) {
    // Passed in options
    if (options !== undefined) {
        if (options.backgroundURL !== undefined) this.backgroundURL = options.backgroundURL;
    }
}
...
if (Meteor.isServer) {
    Accounts.onCreateUser(function(options, user) {
        if (user.meteorOS === undefined) user.meteorOS = {};
